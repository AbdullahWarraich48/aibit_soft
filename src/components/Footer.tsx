...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-blue-800 to-blue-600 text-white px-4 sm:px-6 md:px-8 py-10 md:py-12">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6 md:gap-8">
        {/* Left Column */}
        <div className="order-1 md:order-1 mt-0 md:mt-0">
        <div className="flex items-center space-x-2">
<Image src={footerlogo} alt={footerData.logo.alt} width={footerData.logo.width} height={footerData.logo.height} />
</div>
          <p className="mb-4 text-sm leading-[28px] mt-4 md:mt-7">
          ...
          <div className="mt-4 text-sm font-sans hidden md:flex flex-row items-center gap-4 mt-11">
          ...
          <div className="mt-4 text-sm font-sans hidden md:flex flex-row items-center gap-4 mt-6 ">
          ...
          <div className="mt-4 text-sm font-sans flex flex-row gap-3 md:gap-4 mt-6 md:mt-9 pt-0 md:pt-[90px]">
        ...
        <div className="order-2 md:order-2">
          ...
          <ul className="space-y-3 md:space-y-[15px] text-sm mt-8 md:mt-12 ">
          ...
          {/* Social icons shown under Services on small screens only */}
          <div className="mt-5 text-sm font-sans grid md:hidden grid-cols-5 gap-3">
            <a href="#" aria-label="Facebook" className="group">
              <Image src={fb} alt="Facebook" width={20} height={20} className="transition-transform duration-300 group-hover:scale-110 filter invert brightness-0" />
            </a>
            <a href="#" aria-label="Instagram" className="group">
