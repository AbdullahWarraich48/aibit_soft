      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20 pt-20">
        <div className="text-center">
          ...
          <div className="w-full mt-10">
            <div className="text-center">
              <h3
                className="text-white font-medium leading-[30px] text-2xl"
                style={{ fontFamily: "Sora" }}
              >
                <span className="font-extrabold text-2xl">
                  $260 billion/year
                </span>{" "}
                lost in US & EU due to cart abandonment.
              </h3>
              <h3
                className="text-white font-medium leading-[30px] text-2xl mt-2"
                style={{ fontFamily: "Sora" }}
              >
